...
public class TesteDuasListas {
	public static void main(String[] args) {
		...
		System.out
				.println("Joao passou na frente da gondola dos cereais e verificou se arroz e feijao estavam na lista");
		...
		System.out.println(
				"Como estava na frente da gondola da cebola, ja pegou e tirou da lista, mas lembrou que tambem precisava de ovos:");
		...
		System.out.println(
				"Lista Joao+Maria Esperado batata,cafe,detergente,fosforos,tomate,cenoura,ovos = " + lista.exibir());
		lista2.concatenar(lista3);
		System.out.println(
				"Lista Maria+Joao Esperado tomate,cenoura,ovos,batata,cafe,detergente,fosforos = " + lista2.exibir());

		System.out.println(
				"E ai fizeram uma confusao, juntando tudo de novo... \nEsperado tomate,cenoura,ovos,batata,cafe,detergente,fosforos, batata,cafe,detergente,fosforos,tomate,cenoura,ovos");
		...
		System.out.println(
				"Joao (dividida) Esperado = batata,cafe,detergente,fosforos,tomate,cenoura,ovos\n" + lista4.exibir());
		System.out.println(
				"Maria (divisao da Nova lista) Esperado = tomate,cenoura,ovos,batata,cafe,detergente,fosforos\n"
						+ lista2.exibir());
		System.out.println("E Maria anotou mais uma coisa: cha");
		lista2.inserir("cha");
		System.out.println(
				"Lista Maria Esperado = tomate,cenoura,ovos,batata,cafe,detergente,fosforos,cha\n" + lista2.exibir());

		System.out.println(
				"E Maria entregou uma copia da lista para Joao Esperado = tomate,cenoura,ovos,batata,cafe,detergente,fosforos,cha");
